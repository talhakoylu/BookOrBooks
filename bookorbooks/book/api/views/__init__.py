from .book_views import BookListAPIView, BookDetailAPIView
from .book_page_views import BooksPageListAPIView
from .author_views import AuthorListAPIView, AuthorDetailAPIView
