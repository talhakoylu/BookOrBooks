...
class School(AbstractSchoolBaseModel):
    city = models.ForeignKey(City, on_delete=models.DO_NOTHING, related_name="city_schools", verbose_name=SchoolStrings.SchoolStrings.city_verbose_name)
    ...
    website = models.CharField(max_length=250, verbose_name=SchoolStrings.SchoolStrings.website_verbose_name)
